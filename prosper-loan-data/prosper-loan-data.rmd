...
# Boxplots of loan amounts for each credit grade
ggplot(subset(prosper, !is.na(CreditGrade)),
       aes(CreditGrade, LoanOriginalAmount)) +
  geom_boxplot(aes(color = CreditGrade))
